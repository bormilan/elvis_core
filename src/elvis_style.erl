...
-define(PARENTHESES_IN_MACRO_DEFS,
    ...
    "Functions should contain parenthesis, functions shouldn't"
).
...
parentheses_in_macro_defs(Config, Target, RuleConfig) ->
    Root = get_root(Config, Target, RuleConfig),
    IsMacro = fun(Node) -> is_macro_define_node(Node) end,
    InvalidMacros = elvis_code:find(IsMacro, Root),

    _ = ?PARENTHESES_IN_MACRO_DEFS,
